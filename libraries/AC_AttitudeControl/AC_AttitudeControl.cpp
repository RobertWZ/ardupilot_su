...
void AC_AttitudeControl::attitude_controller_run_quat()
{
    ...
    // Write to log
    AP::logger2().Log_Write_Tilt(attitude_error_vector, _thrust_error_angle);
    ...
    AP::logger2().Log_Write_FeedForward(_rate_target_ang_vel, desired_ang_vel_quat.q2, desired_ang_vel_quat.q3, desired_ang_vel_quat.q4);
...
void AC_AttitudeControl::thrust_heading_rotation_angles(Quaternion& att_to_quat, const Quaternion& att_from_quat, Vector3f& att_diff_angle, float& thrust_vec_dot)
{
    ...
    // disable tilt separation
    Quaternion attitude_error_quat = att_from_quat.inverse() * att_to_quat;
    attitude_error_quat.to_axis_angle(rotation);
    att_diff_angle.x = rotation.x;
    att_diff_angle.y = rotation.y;
    att_diff_angle.z = rotation.z;
